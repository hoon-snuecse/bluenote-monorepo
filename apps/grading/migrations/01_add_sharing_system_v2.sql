-- 1단계: 과제 공유 기능을 위한 데이터베이스 스키마 업데이트 (수정된 버전)
-- 실행 전 반드시 백업을 수행하세요!
-- 외래키 제약조건 오류를 해결한 버전입니다.
...
-- ============================================
-- 4. 기존 데이터 마이그레이션 (외래키 제약조건 추가 전에 실행)
-- ============================================
...
-- ============================================
-- 5. 외래키 제약조건 추가 (데이터 마이그레이션 후)
-- ============================================

-- Assignment-User 관계 (NULL 허용)
ALTER TABLE "Assignment" 
ADD CONSTRAINT "Assignment_userId_fkey" 
FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- Evaluation-User 관계 (NULL 허용)
ALTER TABLE "Evaluation" 
...
/*
-- 외래키 제약조건 제거
ALTER TABLE "Assignment" DROP CONSTRAINT IF EXISTS "Assignment_userId_fkey";
ALTER TABLE "Evaluation" DROP CONSTRAINT IF EXISTS "Evaluation_userId_fkey";
