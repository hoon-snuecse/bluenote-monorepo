-- 기존 데이터 정리: userId가 없는 과제와 평가들 수정 (v3)
...
-- 비밀번호는 bcrypt 해시값이어야 합니다
-- 아래는 'temp123!' 의 bcrypt 해시값입니다
INSERT INTO "User" (id, email, password, name, role, "isActive", "createdAt", "updatedAt")
SELECT 
    gen_random_uuid()::text,
    'hoon@snuecse.org',
    '$2a$10$YourHashedPasswordHere', -- 실제 bcrypt 해시값으로 교체 필요
    'Hoon',
    'TEACHER',
    true,
    CURRENT_TIMESTAMP,
...
생성된 해시값을 위의 INSERT 문에서 '$2a$10$YourHashedPasswordHere' 부분에 넣으세요.
*/